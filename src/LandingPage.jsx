...
import {choiceD, updateD} from './assets/Data/BankingData';
            ...
            <div>
                ...
                <div className="infos">
                    ...
                    <div className="options">
                        {
                            choiceD.map((items)=> {
                                return <Choice {...items} key={items.id}/>
                            })
                        }                        
                    </div>
                </div>
                <div className="update">
                    ...
                    <div className="updatesTopic">
                        {
                            updateD.map((items)=>{
                               return <Update {...items} key={items.id}/>
                            })
                        }                        
                    </div>
                </div>
...
const Update = ({img,author,topic,abt}) =>{
    return(
        <>
